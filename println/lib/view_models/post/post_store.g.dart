...
mixin _$PostStore on _PostStore, Store {
  ...
  late final _$savedPostsListAtom = Atom(
    name: '_PostStore.savedPostsList',
    context: context,
  );

  @override
  ObservableList<PostModel> get savedPostsList {
    _$savedPostsListAtom.reportRead();
    return super.savedPostsList;
  }

  @override
  set savedPostsList(ObservableList<PostModel> value) {
    _$savedPostsListAtom.reportWrite(value, super.savedPostsList, () {
      super.savedPostsList = value;
    });
  }
  ...
  Future<void> initializeSaves(
    ...
    return _$initializeSavesAsyncAction.run(
      () => super.initializeSaves(currentUserId, feedPosts: feedPosts),
    );
  }

  late final _$loadSavedPostsAsyncAction = AsyncAction(
    '_PostStore.loadSavedPosts',
    context: context,
  );
